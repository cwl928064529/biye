...
// needs. Use the setMaxDigits() export function to do this. See comments below.
//
// Tweaked by Ian Bunning
// Alterations:
// Fix bug in export function biFromHex(s) to allow
...
// function. So use this export function to set the variable. DON'T JUST SET THE
